...
public class SSLManager {
    ...
    public static RestAssuredConfig getSSLConfig() {
        try {
            ...
            System.out.println("SSL JKS loaded successfully");
            System.out.println("SSL alias count: " + keyStore.size());
